...
void add_float_array ( int , TYPE * restrict, const TYPE * restrict, const TYPE * restrict );
...
void add_float_array( int N, TYPE * restrict C, const TYPE * restrict A, const TYPE * restrict B)
{
